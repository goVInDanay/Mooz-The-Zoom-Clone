...
import { Chat, Channel, ChannelHeader, MessageInput, MessageList, Thread, Window,MessageContextValue, MessageProps, MessageSimple, useMessageContext } from 'stream-chat-react';
...
const MeetingRoom = () => {
  ...
  const CustomMessage = () => {
    ...
    if (!message) return null; // Prevents errors if message is undefined
